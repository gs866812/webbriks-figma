    ...
    return (
        <div className='w-full bg-[#FFFBF4]'>
            <div className='w-[90%] mx-auto max-w-screen-2xl'>
                <div className="md:bg-gradient-to-r bg-gradient-to-b from-[#FFA726B2] to-[#FFFBF2B2]  rounded-lg md:p-8 flex flex-col md:flex-row md:justify-between md:items-center gap-10 py-8">
